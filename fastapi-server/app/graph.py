...
cursor.execute('''
    CREATE TABLE IF NOT EXISTS MODSECLOG1 (
        ...
        request_host TEXT,
        local_port TEXT,
        request_useragent TEXT,
        request_line TEXT,
        request_line_method TEXT,
        request_line_url TEXT,
        request_line_protocol TEXT,
        ...
        message_rule_id TEXT,
        message_rule_file TEXT,
        message_msg TEXT,
        message_severity TEXT,
        message_accuracy TEXT,
        message_maturity TEXT,
        full_message_line TEXT
    )
''')
conn.commit()
def send_to_db(cursor, transaction_id, event_time,remote_address, request_host, local_port, request_useragent, request_line, request_line_method, request_line_url, request_line_protocol, response_protocol, response_status, action, action_phase, action_message, message_type, message_description, message_rule_id, message_rule_file, message_msg, message_severity, message_accuracy, message_maturity, full_message_line):
    try:
        cursor.execute('''
        INSERT INTO MODSECLOG1 (transaction_id, event_time, remote_address, request_host, local_port, request_useragent, request_line, request_line_method, request_line_url, request_line_protocol, response_protocol, response_status, action, action_phase, action_message, message_type, message_description, message_rule_id, message_rule_file, message_msg, message_severity, message_accuracy, message_maturity, full_message_line)
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
    ''', (transaction_id, event_time,remote_address, request_host, local_port, request_useragent, request_line, request_line_method, request_line_url, request_line_protocol, response_protocol, response_status, action, action_phase, action_message, message_type, message_description, message_rule_id, message_rule_file, message_msg, message_severity, message_accuracy, message_maturity, full_message_line))
        conn.commit()
